...
Opening a pull request will trigger a[Azure DevOps Pipeline](../.azure/devops-pipelines/suramlops01-tests-ci.yml) 
...
Links:
* [Staging model in UC](https://adb-701332733887587.7.azuredatabricks.net/explore/data/models/staging/suramlops01/suramlops01-model)
* [Prod model in UC](https://adb-2900826933759041.1.azuredatabricks.net/explore/data/models/prod/suramlops01/suramlops01-model)
. 
